...
[FFD700]TELEGRAM : [FFFF00]@DRAKONIX_OFFICIAL
[1E90FF]╚══════════════════════════╝""", idinv
                        )
                )
                senthi = False
...
[b][i][A5E2CFٍ]Instagram: @DRAKONIX_OFFICIAL[/b]

[b][c][1E90FF] Telegram: @DRAKONIX_OFFICIAL""",uid
                            )
                        )
                else:
                    pass  
...
[b][i][A5E2CFٍ]telegram: DRAKONIX_OFFICIAL[/b]

[b][c][1E90FF]Instagram : DRAKONIX_OFFICIAL[FFFFFF]
 
[b][i][A5E2CFٍ]telegram: @DRAKONIX_OFFICIAL[/b]

[b][c][1E90FF]Instagram : @DRAKONIX_OFFICICAL[FFFFFF]
 
Enjoy the bot my friend.......

[C][B][FF6347] Developer    DRAKONIX""", uid
                    )
                )
            ...
            if "1200" in data.hex()[0:4] and b"WELCOME TO [FFFFF00]DRAKONIX [ffffff]BOT" in data:
            	pass
            else:
    ...
    f"[B][FFA500]• Bio: [FFFFFF]{bio}\n"
	            ...
	            if "1200" in data.hex()[0:4] and b"/help" in data:
	                ...
	                clients.send(
	                    self.GenResponsMsg(
		                        f"""[B][C][FFFF00] WELCOME TO [ffffff]DRAKONIX BOT  !! 

[C][B][00FF00]/🤔likes [id] -> [C][B][FFFFFF]Apne Id Pe Likes Badhao
		
[FF0000] /🤔info [id] -> [C][B][FFFFFF]Kisi Bhi Player Ka poora details nikalo
	
[00FF00] /🤔status[id] ->  [C][B][FFFFFF]Player Ka Status Dekhe
...
[40E0D0] /🤔region [id] ->        [C][B][FFFFFF] ID Ki Region Jane

[00FF00] /🤔ai [word] -> [C][B][FFFFFF]AI Se Swal Puchhe [DRAKONIX AI]
...
[00FF00] /🤔admin -> [C][B][FFFFFF]Bot Ke Admin Ke Bare Me Jane
...
[00FF00] /🤔3 -> /🤔4 -> /🤔5 -> /🤔6""", uid
	                ...
	                clients.send(
		                    self.GenResponsMsg(
		                        f"""		-------------------------------
[00FF00] /🤔lag (team code)-> [C][B][FFFFFF]Kisi Bhi Team Ko Lag Kre
